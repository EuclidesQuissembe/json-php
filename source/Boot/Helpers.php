 ...
 * @return bool
 */
function is_phone(string $phone, string $country = "ao"): bool
{
...
function str_message_info(string $message): string
{
    return
        "<div class=\"text-center\">" .
            "<h1><i class=\"fa fa-info-circle text-info\"></i></h1>" .
            "<h3>Conteúdo Vazio</h3>" .
 ...
 * @throws Exception
 */
function date_fmt(?string $date, string $format = "d/m/Y à\s H:i"): string
{
